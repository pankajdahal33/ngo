...
const SubPrograms = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    end_date: "",
    total_budget: "",
    agreement: null, // Corrected spelling
  ...
  const handleEdit = (row) => {
    ...
    setFormData({
      ...
      agreement: null, // Reset file on edit
      is_active: row.is_active, // Added field
    });
  };
  ...
  const handleSave = async (e) => {
    ...
    data.append("is_active", formData.is_active); // Added field

    if (formData.agreement) {
      data.append("agreement", formData.agreement); // Corrected spelling
    } else {
